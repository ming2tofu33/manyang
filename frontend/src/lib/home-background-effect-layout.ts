...
const cheeseCatTargets: HomeBackgroundEffectTarget[] = [
  ...
  { name: "cheese-right-candle1", type: "flame", x: 91.2, y: 42.6, size: 50, delay: "0.2s", tone: "gold" },
  { name: "cheese-right-candle2", type: "flame", x: 91.1, y: 24.6, size: 30, tone: "gold" },
  { name: "cheese-left-incense", type: "flame", x: 21.6, y: 44.2, size: 16, delay: "0.5s",tone: "gold" },
  { name: "right-shelf-candle", type: "flame", x: 90.7, y: 17.8, size: 20, delay: "0.4s", tone: "gold" },
  ...
  { name: "cheese-window-moon", type: "orb", x: 10.5, y: 11.3, size: 70, delay: "0.1s", tone: "gold" },
...
const grayCatTargets: HomeBackgroundEffectTarget[] = [
  // 1. Lunar Crystal Orb
  { name: "gray-orb-glow", type: "orb", x: 48.4, y: 55.2, size: 160, tone: "cool" },
  { name: "gray-orb-glow-core", type: "orb", x: 48.4, y: 55.2, size: 80, delay: "0.8s", tone: "white" },
  { name: "gray-orb-mist", type: "smoke", x: 48.4, y: 53.0, size: 100, delay: "1.5s", tone: "cool" },

  // 2. Contrast Lanterns & Candles (Warm Amber & Cool Contrast)
  { name: "gray-left-candle", type: "flame", x: 9.8, y: 38.0, size: 70, delay: "0.2s", tone: "amber" },
  { name: "gray-right-lantern", type: "flame", x: 90.4, y: 47.0, size: 48, delay: "0.4s", tone: "amber" },
  { name: "gray-table-lantern", type: "flame", x: 69.8, y: 58.6, size: 45, delay: "0.7s", tone: "cool" },

  // 3. Crescent Moon & Left Smoke
  { name: "gray-window-moon", type: "orb", x: 15.0, y: 22.3, size: 90, delay: "0.1s", tone: "white" },
  { name: "gray-left-smoke", type: "smoke", x: 8.8, y: 37.0, size: 110, delay: "0.5s", tone: "cool" },

  // 4. Silver Twinkles (Ornaments & Crystals)
  { name: "gray-hat-star", type: "twinkle", x: 67.4, y: 31.0, size: 12, delay: "0.6s", tone: "white" },
  { name: "gray-hat-moon", type: "twinkle", x: 82.0, y: 27.0, size: 14, delay: "1.2s", tone: "cool" },
  { name: "gray-hat-pendant", type: "twinkle", x: 57.6, y: 27.0, size: 15, delay: "2.0s", tone: "cool" },
  { name: "gray-hanging-star", type: "twinkle", x: 35.0, y: 20.0, size: 15, delay: "2.9s", tone: "white" },
  { name: "gray-hourglass-sparkle", type: "twinkle", x: 22.0, y: 51.0, size: 12, delay: "0.8s", tone: "white" },
  { name: "gray-table-crystal-left", type: "twinkle", x: 13.0, y: 64.0, size: 13, delay: "2.4s", tone: "cool" },
  { name: "gray-table-crystal-right", type: "twinkle", x: 79.0, y: 63.0, size: 14, delay: "1.7s", tone: "white" }
];

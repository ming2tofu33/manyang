...
const whiteCatTargets: HomeBackgroundEffectTarget[] = [
  // 1. Pink Crystal Orb
  { name: "white-orb-glow", type: "orb", x: 50.0, y: 55.0, size: 160, tone: "rose" },
  { name: "white-orb-glow-inner", type: "orb", x: 50.0, y: 55.0, size: 80, delay: "1.0s", tone: "white" },
  { name: "white-orb-smoke", type: "smoke", x: 50.0, y: 52.0, size: 100, delay: "1.2s", tone: "rose" },

  // 2. Warm Lantern Glow (left)
  { name: "white-left-lantern", type: "flame", x: 4.0, y: 49.2, size: 60, delay: "0.3s", tone: "gold" },
  { name: "white-left-candle-1", type: "flame", x: 10.0, y: 33, size: 24, delay: "0.8s", tone: "rose" },
  { name: "white-left-candle-2", type: "flame", x: 18.6, y: 27.0, size: 25, delay: "0.1s", tone: "gold" },

  // 3. Crystal Sparkles (Hat, ceiling, table)
  { name: "white-hat-sparkle-1", type: "twinkle", x: 82.0, y: 37.0, size: 15, delay: "0.2s", tone: "white" },
  { name: "white-hat-sparkle-2", type: "twinkle", x: 72.0, y: 29.0, size: 13, delay: "1.5s", tone: "rose" },
  { name: "white-hat-sparkle-3", type: "twinkle", x: 62.0, y: 23.0, size: 14, delay: "2.1s", tone: "white" },

  { name: "white-table-crystal-1", type: "twinkle", x: 77.0, y: 56.0, size: 16, delay: "0.8s", tone: "rose" },
...
const cheeseCatTargets: HomeBackgroundEffectTarget[] = [
  ...
  { name: "cheese-table-crystal-left", type: "twinkle", x: 9.0, y: 54.0, size: 15, delay: "2.7s", tone: "gold" },
  { name: "cheese-table-crystal-right", type: "twinkle", x: 66.8, y: 88.1, size: 12, delay: "1.8s", tone: "amber" }
];
...
const grayCatTargets: HomeBackgroundEffectTarget[] = [
  ...
  { name: "gray-hat-star", type: "twinkle", x: 58.0, y: 16.0, size: 12, delay: "0.6s", tone: "white" },
  { name: "gray-hat-moon", type: "twinkle", x: 86.0, y: 18.0, size: 14, delay: "1.2s", tone: "cool" },
  { name: "gray-hat-pendant", type: "twinkle", x: 79.0, y: 20.0, size: 15, delay: "2.0s", tone: "cool" },
  { name: "gray-hanging-star", type: "twinkle", x: 35.0, y: 15.0, size: 15, delay: "2.9s", tone: "white" },
  { name: "gray-hourglass-sparkle", type: "twinkle", x: 18.0, y: 48.0, size: 12, delay: "0.8s", tone: "white" },
  { name: "gray-table-crystal-left", type: "twinkle", x: 10.0, y: 53.0, size: 13, delay: "2.4s", tone: "cool" },
  { name: "gray-table-crystal-right", type: "twinkle", x: 93.0, y: 58.0, size: 14, delay: "1.7s", tone: "white" }
];

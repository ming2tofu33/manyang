    ...
    outputContract: {
      ...
      interpretation: {
        ...
        structure: [
          ...
          "Do not repeat the summary line verbatim. The summary is the one-line verdict; the interpretation opens by DEVELOPING that verdict with the dream's own specifics (why it reads that way, what follows from it) — it must not restate the summary word-for-word as its first sentence.",

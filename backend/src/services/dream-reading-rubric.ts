...
export function buildRubricJudgePrompt(input: ScoreDreamReadingInput): { instructions: string; input: string } {
  ...
  return {
    instructions: [
      ...
      "delight.fortuneClarity: when a fortune is appropriate, is it vivid and screenshot-worthy. delight.folkFraming: is that fortune framed as traditional folk reading and kept responsible (no absolute guarantee, no health/death claims).",
      "depth.development: is it developed from multiple angles and substantial, without padding or repetition.",
      "Be calibrated and critical: reserve 9-10 for genuinely excellent, 5-6 for adequate, 0-2 for failing. Do not inflate.",
